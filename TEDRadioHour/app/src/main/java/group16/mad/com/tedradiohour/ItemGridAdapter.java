...
public class ItemGridAdapter extends RecyclerView.Adapter<ItemGridAdapter.RowHolder> implements View.OnTouchListener {
    ...
    public ItemGridAdapter(Context context, ArrayList<Item> itemList, MainActivity activity) {
